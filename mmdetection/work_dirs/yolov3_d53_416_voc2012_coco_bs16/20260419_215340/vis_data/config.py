...
optim_wrapper = dict(
    ...
    optimizer=dict(lr=0.00025, momentum=0.9, type='SGD', weight_decay=0.0005),
    type='OptimWrapper')
param_scheduler = [
...
train_cfg = dict(max_epochs=273, type='EpochBasedTrainLoop', val_interval=500)
...
work_dir = 'work_dirs/yolov3_d53_416_voc2012_coco_bs16'
